		...
		Route::middleware(['admincountryblock', 'throttle:refresh', 'ipblockunblock', 'apichecking'])->group(function () {
			...
			Route::group(['namespace' => 'Admin', 'prefix'	 => 'admin'], function () {
				...
				Route::middleware('auth', 'admin.auth')->group(function () {
                    ...
                    Route::get('/note/{id}', 'AdminTicketController@noteshow');
					...
					Route::get('massproduct/delete', 'ProductController@productmassdestroy');
					Route::get('/products/{id}', 'ProductController@show')->name('products.view');

					//------------------
					Route::get('/companies', 'CompanyController@index')->name('companies');
					Route::post('/companies/create', 'CompanyController@store')->name('companies.create');
					Route::get('/companies/delete/{id}', 'CompanyController@destroy');
					Route::get('masscompany/delete', 'CompanyController@productmassdestroy');
					Route::get('/companies/{id}', 'CompanyController@show')->name('companies.view');

					//------------------
					Route::get('/sla', 'SLAController@index')->name('slas');
					Route::post('/sla/create', 'SLAController@store')->name('slas.create');
					Route::get('/sla/delete/{id}', 'SLAController@destroy');
					Route::get('masssla/delete', 'SLAController@slamassdestroy');
					Route::get('/sla/{id}', 'SLAController@show')->name('sla.view');
					//------------------
