@extends('layouts.custommaster')
								...
								<form class="card-body border-top-0 pt-3" id="login" action="{{route('client.do_login')}}" method="post">
									...
									<div class="form-group">
										<label class="form-label">{{trans('langconvert.admindashboard.username')}} <span class="text-red">*</span></label>
										<input class="form-control  @error('username') is-invalid @enderror" placeholder="Username" type="text"
