        ...
        <ul class="side-menu custom-ul">
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.menu.ticket')}}</span><i
                ...
                <ul class="slide-menu custom-ul">
                    ...
                    <li><a href="{{url('/admin/createticket')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.createticket')}}</a></li>
                    @endcan

                    @can('All Tickets')

                    <li><a href="{{url('/admin/alltickets')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.alltickets')}}</a></li>
                    @endcan
                    @can('My Tickets')

                    <li><a href="{{url('/admin/myticket')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.mytickets')}}</a></li>
                    @endcan
                    @can('Active Tickets')

                    <li><a href="{{url('/admin/activeticket')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.activetickets')}}</a></li>
                    @endcan
                    @can('Closed Tickets')

                    <li><a href="{{url('/admin/closedticket')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.closetickets')}}</a></li>
                    @endcan
                    @can('Assigned Tickets')

                    <li><a href="{{url('/admin/assignedtickets')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.assigntickets')}}</a></li>
                    @endcan
                    @can('My Assigned Tickets')

                    <li><a href="{{url('/admin/myassignedtickets')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.myassigntickets')}}</a></li>
                    @endcan
                    @can('Onhold Tickets')
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.categories')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    @can('Category Access')
                    ...
                    <li><a href="{{url('/admin/categories')}}"
                            class="slide-item">{{trans('langconvert.newwordslang.maincategories')}}</a></li>
                    @endcan

                    @can('Subcategory Access')

                    <li><a href="{{url('/admin/subcategories')}}"
                            class="slide-item">{{trans('langconvert.newwordslang.subcategory')}}</a></li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.menu.knowledge')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    ...
                    <li><a href="{{url('/admin/article')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.articles')}}</a></li>
                    @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{url('/admin/products')}}">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.products')}}</span>
                </a>
            </li>
            @endcan
            @can('Project Access')
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{url('/admin/sla')}}">
                    <svg class="sidemenu_icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                        height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                        <g>
                            <rect fill="none" height="24" width="24" />
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.sla')}}</span>
                </a>
            </li>
            @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.manageroles')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    ...
                    <li><a href="{{url('/admin/role')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.rolespermission')}}</a></li>
                    @endcan
                    @can('Roles & Permission Create')

                    <li><a href="{{url('/admin/employee/create')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.createemployee')}}</a></li>
                    @endcan
                    @can('Employee Access')

                    <li><a href="{{url('/admin/employee')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.employeeslist')}}</a></li>
                    @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.landingpagesetting')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    @can('Banner Access')
                    ...
                    <li><a href="{{url('/admin/bannersetting')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.banner')}}</a></li>
                    @endcan
                    @can('Feature Box Access')

                    <li><a href="{{url('/admin/feature-box')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.featurebox')}}</a></li>
                    @endcan
                    @can('Call To Action Access')

                    <li><a href="{{url('/admin/call-to-action')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.callactionbox')}}</a></li>
                    @endcan
                    @can('Testimonial Access')

                    <li><a href="{{url('/admin/testimonial')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.testimonial')}}</a></li>
                    @endcan
                    @can('FAQs Access')
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{url('/admin/companies')}}">
                    <svg class="sidemenu_icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                        height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                        <g>
                            <rect fill="none" height="24" width="24" />
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.companies')}}</span>
                </a>
            </li>
            @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.newwordslang.envato')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.newwordslang.appinfo')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.groups')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    @can('Groups Create')
                    ...
                    <li><a href="{{url('/admin/groups/create')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.creategroup')}}</a></li>
                    @endcan
                    @can('Groups List Access')

                    <li><a href="{{url('/admin/groups')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.grouplist')}}</a></li>
                    @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.notification')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    <li><a href="{{route('notificationpage')}}"
                            class="slide-item smark-all">{{trans('langconvert.adminmenu.allnotifys')}}</a></li>

                    @can('Custom Notifications Access')

                    <li><a href="{{route('mail.index')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.customnotify')}}</a></li>
                    @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.custompages')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    @can('Pages Access')
                    ...
                    <li><a href="{{url('/admin/pages')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.pages')}}</a></li>
                    @endcan
                    @can('404 Error Page Access')

                    <li><a href="{{url('/admin/error404')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.404errorpage')}}</a></li>
                    @endcan
                    @can('Under Maintanance Page Access')

                    <li><a href="{{url('/admin/maintenancepage')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.undermaintanenece')}}</a></li>
                    @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('langconvert.adminmenu.appsetting')}}</span><i
                        class="angle fa fa-angle-right"></i>
                </a>
                <ul class="slide-menu custom-ul">
                    ...
                    <li><a href="{{url('/admin/general')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.generalsetting')}}</a></li>
                    @endcan
                    @can('Ticket Setting Access')

                    <li><a href="{{url('/admin/ticketsetting')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.ticketsetting')}}</a></li>
                    @endcan
                    @can('SEO Access')

                    <li><a href="{{url('/admin/seo')}}" class="slide-item">{{trans('langconvert.adminmenu.seo')}}</a>
                    </li>
                    @endcan
                    @can('Google Analytics Access')

                    <li><a href="{{url('/admin/googleanalytics')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.googleanalytics')}}</a></li>
                    @endcan
                    @can('Custom JS & CSS Access')

                    <li><a href="{{url('/admin/customcssjssetting')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.customjscss')}}</a></li>
                    @endcan
                    @can('Captcha Setting Access')

                    <li><a href="{{url('/admin/captcha')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.captchasetting')}}</a></li>
                    @endcan
                    @can('Social Logins Access')

                    <li><a href="{{url('/admin/sociallogin')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.sociallogin')}}</a></li>
                    @endcan
                    @can('Email Setting Access')

                    <li><a href="{{url('/admin/emailsetting')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.emailsetting')}}</a></li>
                    @endcan
                    @can('Custom Chat Access')

                    <li><a href="{{url('/admin/customchatsetting')}}"
                            class="slide-item">{{trans('langconvert.admindashboard.externalchat')}}</a></li>
                    @endcan
                    @can('Maintenance Mode Access')

                    <li><a href="{{url('/admin/maintenancemode')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.maintanacemode')}}</a></li>
                    @endcan
                    @can('SecruitySetting Access')

                    <li><a href="{{url('/admin/securitysetting')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.securitysetting')}}</a></li>
                    @endcan
                    @can('IpBlock Access')

                    <li><a href="{{route('ipblocklist')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.iplist')}}</a></li>
                    @endcan
                    @can('Emailtoticket Access')

                    <li><a href="{{route('admin.emailtoticket')}}"
                            class="slide-item">{{trans('langconvert.adminmenu.emailtoticket')}}</a></li>
                    @endcan
