											...
											<table class="table table-vcenter text-nowrap table-bordered table-striped ticketdeleterow w-100" id="support-articlelists">
												<thead>
													<tr>
														...
														<th >{{trans('langconvert.admindashboard.product')}}</th>
														<th >{{trans('langconvert.admindashboard.company')}}</th>
														<th >{{trans('langconvert.adminmenu.sla')}}</th>
														<th >{{trans('langconvert.adminmenu.agent')}}</th>
														<th >{{trans('langconvert.admindashboard.start_date')}}</th>
														<th >{{trans('langconvert.admindashboard.end_date')}}</th>
					...
					$.ajax({
						...
						success: (data) => {
							...
							if(data.errors){
								...
								$('#dateError').html(data.errors.end_date);
