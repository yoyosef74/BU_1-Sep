			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form method="POST" enctype="multipart/form-data" id="projects_form" name="projects_form">
                        <input type="hidden" name="sla_id" id="projects_id">
                        @csrf
                        @honeypot
                        <div class="modal-body">
                            <div class="form-group test">
                                <label class="form-label">{{trans('langconvert.admindashboard.slaname')}} <span class="text-red">*</span></label>
                                <input type="text" class="form-control" name="name" id="name">
                                <span id="nameError" class="text-danger alert-message"></span>
                            </div>
                            <div class="form-group test">
                                <label class="form-label">{{trans('langconvert.admindashboard.tickets_monthly')}} <span class="text-red">*</span></label>
                                <input type="number" class="form-control" name="tickets_monthly" id="tickets_monthly" required>
                            </div>
                        </div>
