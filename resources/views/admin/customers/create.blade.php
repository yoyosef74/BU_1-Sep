...
<div class="page-header d-xl-flex d-block">
	<div class="page-leftheader">
		<h4 class="page-title"><span
				class="font-weight-normal text-muted ms-2">{{trans('langconvert.admindashboard.customer')}}</span></h4>
	</div>
</div>
<!--End Page header-->
		...
		<form method="POST" action="{{url('/admin/customer/create')}}" enctype="multipart/form-data">
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6">
						<div class="form-group">
							<label class="form-label">{{trans('langconvert.admindashboard.username')}} <span
									class="text-red">*</span></label>
					...
					<div class="col-sm-6 col-md-6">
						<div class="form-group {{ $errors->has('company_id') ? ' has-danger' : '' }}">
							<label for="theme_color-input"
								class="form-label">{{trans('langconvert.admindashboard.company')}}</label>
							<select id="company_id"
								class="form-control select2 @error('company_id') is-invalid @enderror"
								data-placeholder="Select Company" name="company_id">
